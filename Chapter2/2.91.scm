...
;; 5. Division tests
;;(let ((div-result
;;       (div dense-poly-g sparse-poly-u)))
;;  (assert-eque
;;   (quotient-of div-result)
;;   (poly-sparse (list (make-term 2 (num 1))))
;;   "Divide dense-poly-g by sparse-poly-u (dense/sparse division) - quotient")

;;  (assert-equ
;;   (remainder-of div-result)
;;   (poly-sparse (list (make-term 0 (num 1))))
;;   "Divide dense-poly-g by  sparse-poly-u (dense/sparse division) - remainder"))
;; Sparse/dense works but the otherwise not. it is brealn
